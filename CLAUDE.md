...
## Hero Battle Sprite Rule (FIXED 2026-06-07)
...
- **Direction**: CSS `scaleX(-1)` flips the portrait when `heroFacingLeft` is true (idle), and `scale(-1.35, 1.35)` for running-left
...
- Only Miti (`/sprites/miti/`) has directional sprite sheets; all heroes use the hero portrait image system

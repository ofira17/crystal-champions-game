...
const AUTO_SUBJECTS_BY_GRADE: Record<number, string> = {
  1: "ספירה ומספרים עד 20, צבעים, חיות, אותיות וצלילים, חיי יום-יום",
  2: "חיבור וחיסור עד 100, אוצר מילים, חיות וצמחים, מזג אוויר, גוף האדם",
  3: "כפל וחילוק פשוטים, הבנת הנקרא, חלל ראשוני, יבשות ואוקיינוסים, חידות לוגיות",
  4: "שברים, דקדוק, מדעי הטבע, מערכת השמש, מפות ומדינות, אירועים היסטוריים",
  5: "אחוזים ומשוואות, ניתוח טקסט, ביולוגיה ופיזיקה ראשונית, גיאוגרפיה עולמית, היסטוריה כללית",
  6: "אלגברה ראשונית, ניתוח ספרותי, כימיה ופיזיקה, גיאוגרפיה מתקדמת, היסטוריה עולמית, לוגיקה",
};
